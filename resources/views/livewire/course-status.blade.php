            ...
            <div class="card-body">
               ...
               <div class="relative pt-1">
                  <div class="flex h-2 mb-4 overflow-hidden text-xs bg-pink-200 rounded">
                    <div style="width:{{ $this->advance .'%' }}" class="flex flex-col justify-center text-center text-white transition-all duration-500 bg-pink-500 shadow-none whitespace-nowrap"></div>
                  </div>
                </div>
