<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    ...
    <ul class="absolute z-50 left-0 w-full bg-white mt-1 rounded-lg overflow-hidden">
        ...
        <li class="leading-10 px-5 text-sm cursor-pointer hover:bg-gray-300" >
            ...
            <a href="<?php echo e(route('courses.show', $result)); ?>"><?php echo e($result->title); ?></a>
...
</form><?php /**PATH C:\xampp\htdocs\Trend\platform\resources\views/livewire/search.blade.php ENDPATH**/ ?>